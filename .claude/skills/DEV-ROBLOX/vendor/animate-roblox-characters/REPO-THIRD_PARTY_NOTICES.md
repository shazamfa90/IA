...
**Roblox Animations Importer/Exporter 2.6.3** by Cautioned is bundled unmodified as `animate-roblox-characters/assets/blender-addons/rbx_anims_v2.6.3.zip` under GPL-3.0-or-later. Its license is included at `animate-roblox-characters/assets/blender-addons/Cautioned-Blender-Animations-Plugin-LICENSE.txt`.
